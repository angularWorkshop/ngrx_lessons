# Добавить summary selector, который считает completed/remaining по normalized entities.
...
return {
  ...
  exercise: "Добавить summary selector, который считает completed/remaining по normalized entities.",
  feature: '...',
  status: 'completed',
