# Покрыть CoursesFacade: vm$, opened(), filterChanged(), selected().
...
Тестирование action contracts и store facade
...
return {
  ...
  exercise: "Покрыть CoursesFacade: vm$, opened(), filterChanged(), selected().",
  feature: '...',
  status: 'completed',
