...
describe("Заменить набор boolean-флагов на discriminated union request state.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Заменить набор boolean-флагов на discriminated union request state.");
