...
describe("Собрать selectCoursesPageVm с состояниями loading/error/empty/success.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Собрать selectCoursesPageVm с состояниями loading/error/empty/success.");
