...
describe("Поймать type-error в reducer, где action payload не совпадает с state model.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Поймать type-error в reducer, где action payload не совпадает с state model.");
