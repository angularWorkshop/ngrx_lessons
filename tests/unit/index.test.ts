...
describe("Создать reusable withRequestStatus feature и применить его к двум SignalStore.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Создать reusable withRequestStatus feature и применить его к двум SignalStore.");
