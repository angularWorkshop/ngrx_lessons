...
describe("Исправить selector, который каждый раз создаёт новый массив и ломает memoization.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Исправить selector, который каждый раз создаёт новый массив и ломает memoization.");
