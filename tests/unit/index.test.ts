...
describe("Найти пять NgRx anti-patterns в готовой feature и предложить refactoring plan.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    expect(exerciseContract.course).toBe('NGRX');
    expect(exerciseContract.topic).toBe("Anti-patterns NgRx: Store как база данных, action explosion и selector soup");
    expect(exerciseContract.exercise).toBe("Найти пять NgRx anti-patterns в готовой feature и предложить refactoring plan.");
