...
describe("Настроить devtools так, чтобы production-сборка не тащила лишнюю диагностику.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Настроить devtools так, чтобы production-сборка не тащила лишнюю диагностику.");
