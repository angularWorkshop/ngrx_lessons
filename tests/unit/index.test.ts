...
describe("Создать ComponentStore для upload widget с состояниями idle/uploading/error/done.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Создать ComponentStore для upload widget с состояниями idle/uploading/error/done.");
