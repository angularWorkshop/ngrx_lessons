...
describe("Покрыть CoursesFacade: vm$, opened(), filterChanged(), selected().", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Покрыть CoursesFacade: vm$, opened(), filterChanged(), selected().");
