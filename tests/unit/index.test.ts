...
describe("Связать локальный save flow с глобальным Courses actions без прямой мутации global state.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Связать локальный save flow с глобальным Courses actions без прямой мутации global state.");
