...
describe("Реализовать effect загрузки списка курсов через CoursesApi.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Реализовать effect загрузки списка курсов через CoursesApi.");
