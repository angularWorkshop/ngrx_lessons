...
describe("Разделить actions страницы и actions API-слоя, сохранив читаемый flow.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Разделить actions страницы и actions API-слоя, сохранив читаемый flow.");
