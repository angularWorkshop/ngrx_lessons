...
describe("Покрыть LessonEditor SignalStore: patch, dirty flag и save flow.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Покрыть LessonEditor SignalStore: patch, dirty flag и save flow.");
