...
describe("Собрать Courses Dashboard Store: actions, reducer, selectors и vm selector.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Собрать Courses Dashboard Store: actions, reducer, selectors и vm selector.");
