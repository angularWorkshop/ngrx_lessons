...
describe("Разложить хаотичную NgRx-фичу по понятной структуре файлов.", () => {
  it('keeps the NgRx exercise contract explicit', () => {
    ...
    expect(exerciseContract.exercise).toBe("Разложить хаотичную NgRx-фичу по понятной структуре файлов.");
